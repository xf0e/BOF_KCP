...
class TKCADVBOFAPIPlugin:public TDFShellAPIPlugin<SESSIONCLASS, PLUGINCLASS>,
...
public:
    ...
    //!	@name	KCBOFAPI
    //@{
    DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_ClearIndexKey)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_AddIndexKey)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_ClearIndexValue)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_SetIndexValue)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_BeginProcess)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_AddImageFile)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_EndProcess)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_AbortProcess)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_GetSupportedFileTypes)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_SetOutputFileType)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_ValidateConfig)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_GetFilePathName)
        DFAPI_PLUGIN_STD_INTERFACE(PLUGINCLASS, KCBOFAPI_SetFilePathName)
        //@}
